...
function Page() {
  ...
  return (
    <div className="w-full">
      <div className="w-full bg-[#191917]  h-[87vh]">
        <div className="relative h-[90vh]">
          ...
          {/* 视频播放器 */}
          <div className="flex flex-col pl-20 flex-1 pt-6">
            <div
              id="video_wrapper"
              onClick={() => {
            ...
            >
              <Player
                ref={xdclassPlayer}
                getVideoData={getVideoData as any}
          ...
          {expandShow && (
            <div className="z-10 ">
              {/* 章集  */}
              {
                <div className="cursor-pointer bg-[#20201e] text-[#fff] absolute top-[0%] left-[150px] h-[85%]">
                  <div
                    id="chapter_section"
                    ref={list}
